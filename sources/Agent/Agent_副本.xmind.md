...
- compiled-concept: [[concepts/Agent 控制模式|Agent 控制模式]] - Reflection/Tool Use/Planning/Multi-agent Collaboration 是控制模式谱系的早期表达。
- compiled-concept: [[concepts/多 Agent 协作协议|多 Agent 协作协议]] - 多 Agent 协作的「现实多人协作类比」是该概念页的早期形态证据。
- updates: [[concepts/AI Agent|AI Agent]] - 早期设计模式补入 Agent 概念页的模式谱系。
