...
- compiled-concept candidate: [[concepts/AI 软件工厂|AI 软件工厂]] — 可沉淀“用 Agent 工作流封装软件交付流程”的概念。
- compiled-concept candidate: [[concepts/技能即代码|技能即代码]] — source 将 SKILL.md 视为可执行 prompt 和流程代码。
- compiled-concept candidate: [[concepts/交叉模型评审|交叉模型评审]] — source 以 Claude 与 Codex 的二次评审说明异构模型验证。
- map-entry candidate: [[maps/Vibe 工具学习地图|Vibe 工具学习地图]] — 可作为 Claude Code 周边工具链和工程工作流案例。
