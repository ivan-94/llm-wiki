...
- related: AI 软件工厂 — 可沉淀“用 Agent 工作流封装软件交付流程”的概念。
- related: 技能即代码 — source 将 SKILL.md 视为可执行 prompt 和流程代码。
- related: 交叉模型评审 — source 以 Claude 与 Codex 的二次评审说明异构模型验证。
- related: Vibe 工具学习地图 — 可作为 Claude Code 周边工具链和工程工作流案例。
