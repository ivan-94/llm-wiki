...
- related: Goal Mode — 可提炼目标、评分、停止条件和持续迭代循环。
- related: Agent 反馈回路 — 可补充快速反馈、评分质量和迭代成本之间的关系。
- related: Agent 外部记忆 — 可沉淀 PLAN.md、EXPERIMENTS.md、EXPERIMENT_NOTES.md 的角色分工。
