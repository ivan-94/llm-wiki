...
- compiled-concept-candidate: [[concepts/Vibe Coding|Vibe Coding]] — 可沉淀定义、风险、最佳实践和与 AI Assisted Engineering 的区别；候选，未创建。
- compiled-concept-candidate: [[concepts/AI 辅助工程|AI 辅助工程]] — 可承载规格、严谨性、人机协作和信任模型；候选，未创建。
- map-entry-candidate: [[maps/Vibe Coding 学习地图|Vibe Coding 学习地图]] — 可作为 Vibe 主题总入口；候选，未创建。
