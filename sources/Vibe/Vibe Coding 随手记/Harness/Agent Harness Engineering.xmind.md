...
- related: [[concepts/Agent Runtime|Agent Runtime]] — source 将 harness 类比为 runtime + compiler，可支撑 runtime 边界定义。
...
- related: [[concepts/Agent Harness|Agent Harness]] — 可与同目录 Harness 循环、Skills 图形成跨 source 综合。
