...
- related: [[concepts/Agent Runtime|Agent Runtime]] — 可补充 Agent 操作系统、runtime、syscall/library/config 的比喻。
- related: [[concepts/Agent 可观测性|Agent 可观测性]] — 图中明确列出 runtime observability 作为新工程能力。
