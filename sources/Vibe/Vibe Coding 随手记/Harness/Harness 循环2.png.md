...
- compiled-concept candidate: [[concepts/Agent Harness|Agent Harness]] — 可提供 harness 循环和可优化对象。
- compiled-concept candidate: [[concepts/Agent 行为塑形|Agent 行为塑形]] — 图中强调通过观察和环境设计塑造 Agent 行为。
- compiled-synthesis candidate: [[synthesis/Agent Harness 工程化框架|Agent Harness 工程化框架]] — 可与 Harness 循环1 和 XMind sources 共同综合成闭环模型。
- map-entry candidate: [[maps/Vibe Coding 学习地图|Vibe Coding 学习地图]] — 可作为从“写代码”转向“调教运行环境”的学习入口。
