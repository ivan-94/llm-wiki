...
- compiled-entity: [[entities/Agent Game|Agent Game]] — 本 source 定义 repo 即世界、文件即记忆的文件系统游戏项目。
- related: [[concepts/AGENTS.md 设计模式|AGENTS.md 设计模式]] — `AGENTS.md` 作为规则引擎与 AGENTS.md 设计模式直接对应。
- related: [[concepts/Agent Harness|Agent Harness]] — hooks（强制存档、随机变量）是 harness 约束层的实例。
...
- “文件系统作为 Agent 状态层”尚未单独建 concept 页；模式已编入 [[entities/Agent Game|Agent Game]] 与 [[concepts/Agent Harness|Agent Harness]]。
