...
- compiled-concept candidate: [[concepts/Agent Coding Guardrails|Agent Coding Guardrails]] — 可用于沉淀模型写代码时的澄清、简洁、精准修改规则。
- compiled-concept candidate: [[concepts/Vibe Coding 工程纪律|Vibe Coding 工程纪律]] — 可作为 Vibe Coding 从即兴生成走向可控执行的约束材料。
- map-entry candidate: [[maps/Vibe Coding 学习地图|Vibe Coding 学习地图]] — 可放入“agent coding 行为规范与反模式”路径。
