...
- Link cleanup candidate: related: Software 3.0 — 可用于沉淀 prompt/context/tools/environment 作为程序的新模型。.
- Link cleanup candidate: related: AI-native 工程师 — 可用于总结工程师价值从编码转向规格、审查和系统杠杆。.
