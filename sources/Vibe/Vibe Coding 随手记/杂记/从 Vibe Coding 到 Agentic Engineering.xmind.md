...
- compiled-concept candidate: [[concepts/Software 3.0|Software 3.0]] — 可用于沉淀 prompt/context/tools/environment 作为程序的新模型。
- compiled-concept candidate: [[concepts/Vibe Coding|Vibe Coding]] — 可用于定义自然语言驱动 Agent 和快速验证的软件生产方式。
- compiled-concept candidate: [[concepts/Agentic Engineering|Agentic Engineering]] — 可用于沉淀围绕 Agent 的规格、验证、监督和安全工程纪律。
- compiled-concept candidate: [[concepts/AI-native 工程师|AI-native 工程师]] — 可用于总结工程师价值从编码转向规格、审查和系统杠杆。
- map-entry candidate: [[maps/Vibe Coding 学习地图|Vibe Coding 学习地图]] — 可作为从范式、工具、边界到工程纪律的主线材料。

## Maintenance Notes

- Helper command succeeded and exported the only discovered sheet. 根节点链接未联网核验。
