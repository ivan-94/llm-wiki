...
Use this skill to publish the compiled AI wiki from the repo to the iCloud Obsidian vault used on iOS. The repo remains canonical; the iCloud vault is a read-only mirror.
