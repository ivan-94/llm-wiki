...
- 视觉与 DSL 扩展：adversarial-ui-review-loop、visual-fidelity-loop 和 create-dsl-skills 说明 Matt Pocock Skills 体系也覆盖 UI 质量循环和 skill 契约化。
...
- [[sources/Vibe/工具/mattpocock:skills  ⭐/adversarial-ui-review-loop.png|adversarial-ui-review-loop]] — 无设计稿 UI 审美审查循环。
- [[sources/Vibe/工具/mattpocock:skills  ⭐/visual-fidelity-loop.png|visual-fidelity-loop]] — 有目标设计稿时的视觉还原证据循环。
- [[sources/Vibe/工具/mattpocock:skills  ⭐/create-dsl-skills.png|create-dsl-skills]] — DSL-backed skill contract 路线。
