...
- 研发自动化瓶颈迁移：AI lab 内部工程和实验执行被 agent 加速后，方向选择、评分、结果可信度、审查和社会治理成为新的瓶颈。
- 审查 slop：当 AI review 自身缺少证据链、误报护栏和回归 eval 时，L4 Evidence 会被泛泛建议污染。
...
- [[human/sources/inbox/cook-blog/2026-06-05_当 AI 开始构建自己_Anthropic|当 AI 开始构建自己]] 支撑 AI 研发自动化后的人类瓶颈迁移和治理窗口判断。
- [[human/sources/inbox/cook-github/2026-06-10_AI审查Slop治理_brooks-lint_hyhmrright_brooks-lint|brooks-lint：AI 审查 Slop 治理]] 支撑 L4 Evidence / L5 Learning 中 review 反 slop 的具体工具案例。
