...
- human source 补充：Agent Harness 可以理解为模型之外的工程系统，负责环境、权限、上下文、观察和验证；AI Coding 率先爆发，是因为软件工程已有 Git、测试、编译、日志、CI 和 review 这类可验证资产。
- human source 补充：harness 不应无限增厚；随着模型能力提升，曾经必要的脚手架和规则需要定期删除或下沉到更窄的 skill/runtime 层。
...
- [[human/sources/inbox/cook-podcast/2026-05-31_Agent Harness 工程系统_硬地骇客|Agent Harness 工程系统]] — human source，系统解释 harness 如何把模型接入真实环境并形成工具、权限、上下文、观察和验证闭环。
- [[human/sources/inbox/cook-github/2026-06-01_Harness团队架构工厂_revfactory_harness|Harness 团队架构工厂]] — human source，提供 team-architecture factory 和 orchestrator skill 生成案例。
- [[human/sources/inbox/cook-podcast/2026-05-31_Y Combinator Startup Podcast_Inside Claude Code With Its Creator Boris Cherny|Inside Claude Code With Its Creator Boris Cherny]] — human source，补充最小脚手架、短规则和随模型能力删除约束的产品方法论。
- [[human/sources/inbox/cook-my-mind/2026-06-02_Codex作为个人系统超级入口|Codex 作为个人系统超级入口]] — human source，把个人知识系统也视为需要入口、边界、来源清单和反馈闭环的 harness。
- [[human/sources/inbox/cook-tweet/2026-06-01_AI输出质量控制与Hermes评估循环_EXM7777|AI 输出质量控制与 Hermes 评估循环]] — human source，补充 eval gate 作为 feedback layer。
