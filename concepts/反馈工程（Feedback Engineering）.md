...
- 视觉任务中的 visual diff、响应式截图和状态验证是反馈工程的一种领域化信号设计。
...
- [[sources/Vibe/工具/mattpocock:skills  ⭐/visual-fidelity-loop.png|visual-fidelity-loop.png]] — 提供视觉任务的 target/diff/patch/verify 反馈回路。
...
- related: [[concepts/视觉还原证据链|视觉还原证据链]] — visual diff 是视觉实现任务的反馈信号。
