...
- Claude Code 动态工作流提供一个混合形态：外层 JavaScript 脚本持有 workflow 控制流，内部子代理仍可在局部任务中动态决策。
...
- [[sources/Vibe/工具/Claude Code/动态工作流.xmind|动态工作流.xmind]]
...
- related: [[concepts/Loop Engineering|Loop Engineering]] — Loop Engineering 常通过 workflow 外壳组织 agent 动态执行
