...
- last30days-skill 补充：近实时多源研究是 JIT 检索的工具化形态，Agent 不预载所有社会信号，而是在任务需要时调用 source adapters、排序、聚类和渲染管线。
...
- [[human/sources/inbox/cook-github/2026-06-09_近30天多源研究技能_mvanhorn_last30days-skill|近30天多源研究技能]] — human source，补充多源近实时信号的按需检索案例。
